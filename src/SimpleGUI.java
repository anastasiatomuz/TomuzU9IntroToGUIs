...
public class SimpleGUI extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source instanceof JButton){
            ...
            if (text.equals("Send")) {
                ...
                JFrame newWindow = new JFrame("my new window");
                // setting up the frame
                newWindow.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                newWindow.setSize(200, 175);
                newWindow.setLocation(350, 75);
                JPanel newWindowPanel = new JPanel();
                JLabel message = new JLabel("hello!!!");
                newWindowPanel.add(message);
                newWindow.add(newWindowPanel, BorderLayout.NORTH);
            ...
            if (text.equals("Open")){
                ...
                // setting up the frame
                newWindow.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                newWindow.setSize(400, 175);
                newWindow.setLocation(350, 75);
                JPanel newWindowPanel = new JPanel();
                JLabel message1 = new JLabel("What’s the best thing about Switzerland?");
                newWindowPanel.add(message1);
                newWindow.add(newWindowPanel, BorderLayout.NORTH);
                JPanel panel2 = new JPanel();
                JLabel message2 = new JLabel("I don’t know, but the flag is a big plus.");
                panel2.add(message2);
                newWindow.add(panel2, BorderLayout.CENTER);
                newWindow.setVisible(true);
    ...
    public void stateChanged(ChangeEvent e){
        Object source = e.getSource();
        JSlider sliderForAction = (JSlider) source;
        String val = String.valueOf(sliderForAction.getValue());
